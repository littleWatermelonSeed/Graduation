...
public class ControlWriteForum  implements BmobSaveMsgWithImg {
    ...
    public ControlWriteForum(Context context){
        this.context = context;
        manager = BmobManageForum.getManager();
    }

    public void releaseLost(final ForumBean bean, final List<String> imgPath){
                ...
                new DialogLoading.ShowLoadingDone() {
                    ...
                    public void done(ViewHolder viewHolder, final BaseNiceDialog baseNiceDialog) {
                        ...
                        if (imgPath == null || imgPath.size() <= 0){
                            manager.uploadMsgWithoutImg(bean,ControlWriteForum.this);
                        }else {
                            manager.uploadMsgWithImg(bean,imgPath,ControlWriteForum.this);
                        }
                    }
                });
    }
