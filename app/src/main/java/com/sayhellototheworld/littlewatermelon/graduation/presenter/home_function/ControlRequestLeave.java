...
import com.sayhellototheworld.littlewatermelon.graduation.adapter.RequestLeaveAdapter;
...
public class ControlRequestLeave implements OnLoadMoreListener,OnRefreshListener,BmobQueryDone<RequestLeaveBean> {
    ...
    private RequestLeaveAdapter adapter;
    private List<RequestLeaveBean> requestData;

    private boolean loading = false;
    private int nowSkip = 0;

    public ControlRequestLeave(Context context, SmartRefreshLayout refreshLayout, RecyclerView recyclerView) {
        ...
        adapter = new RequestLeaveAdapter(context,requestData);
    ...
    public void onLoadMore(RefreshLayout refreshLayout) {
        loading = true;
        manager.queryByStudent(BmobManageUser.getCurrentUser(),nowSkip,this);
    }
